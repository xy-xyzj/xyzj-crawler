...
import com.xyzj.crawler.framework.factory.M3u8SpiderRule;
...
public class DoRule51Cto {
    ...
    public static void main(String[] args) {
        ...
        ISpiderRule spiderRule = new SpiderRuleFactory(new M3u8SpiderRule()).getInstance();
        HashMap<String, Object> params = new HashMap<>(16);
        params.put("httpUrl", httpUrl);
        params.put("fileName", fileName);
        params.put("headerInfosMap", headerInfosMap);
