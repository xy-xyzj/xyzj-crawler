 ...
 * 根据关键字 取得链接 并取得其内容
 * */
public class Qd8ZhaopingSpiderRule extends SpiderRuleAbstract {
	@Override
	public void runSpider(GoodsPO goodsPO)  {
		try {
			...
			for (String mystr : stringList) {
				...
				Qd8ZhaopingDetailSpiderRule qd8ZhaopingDetailSpiderRule = new Qd8ZhaopingDetailSpiderRule();
				qd8ZhaopingDetailSpiderRule.runSpider(savePO);
			}
	...
	public static void main(String[] args) {
		...
		Qd8ZhaopingSpiderRule spiderUtils = new Qd8ZhaopingSpiderRule();
