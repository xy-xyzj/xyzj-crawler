...
public class SpiderRuleSfda extends SpiderRuleAbstract {
	...
	public void runSpider(String srcUrl) {
		...
		for (String content : nameTxt) {
			...
			//|在Excel表中做拆列
			medicineSfdaPO.setContent(content.replace(" ","| "));
